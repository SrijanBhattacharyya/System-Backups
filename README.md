...
* [Garuda Linux i3wm](Garuda-Linux-i3wm-bakups)

## Detailed Info [Topic Wise]
### Arch Linux i3wm
  1. [Installed Packages](Arch-Linux-i3wm-bakups/pkgs.json)
  2. [Config Files](Arch-Linux-i3wm-bakups/cfg)
  3. [Original Config Files' Paths](Arch-Linux-i3wm-bakups/cfg/origin.json)
  4. [Destination Config Files' Paths](Arch-Linux-i3wm-bakups/cfg/destination.json)
...
#### Configuration Files
  ...
  5. [Alacritty Config File](Arch-Linux-i3wm-bakups/cfg/alacritty.yml)
  6. [Flameshot Config File](Arch-Linux-i3wm-bakups/cfg/flameshot.ini)
  7. [i3status Config File](Arch-Linux-i3wm-bakups/cfg/i3status.conf)
  8. [i3workspaces Config File](Arch-Linux-i3wm-bakups/cfg/i3workspaces.conf)
  9. [Neofetch Config File](Arch-Linux-i3wm-bakups/cfg/config.conf)
  10. [picom Config File](Arch-Linux-i3wm-bakups/cfg/picom.conf)

### Garuda Linux i3wm
  1. [Installed Packages](Garuda-Linux-i3wm-bakups/pkgs.json)
  2. [Config Files](Garuda-Linux-i3wm-bakups/cfg)
